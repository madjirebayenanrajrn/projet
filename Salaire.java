...
public class Salaire {
     ...
     */
=m^)à*      P.ajouterEmployés(new Vendeur("Flavien", "Business", 45, "1995", 100));
        P.ajouterEmployé(new Représentant("Fabrice", "Vendtout", 25, "2001", 200));
        P.ajouterEmployé(new Technicien("Franklin", "Bosseur", 28, "1998", (100+200)*5));
        P.ajouterEmployé(new Manutentionnaire("Gloria", "Stocketout", 32, "1998", 65));
        P.ajouterEmployé(new TechnARisque("Fernand", "Flippe", 28, "200", 100));
        P.ajouterEmployé(new ManutARisque("Al", "Abordage", 30, "2001", 65));
